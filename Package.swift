...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "AppSpectorSDK",
            path: "AppSpectorSDK/AppSpectorSDK.xcframework.zip",
            checksum: "19eeb4c08654599ef9a9c14340d8c9caf3c2fcc25eeb4f25e17152897b030e4c"
        ),
        .binaryTarget(
            name: "AppSpectorSDKE2E",
            path: "AppSpectorSDKE2E/AppSpectorSDKE2E.xcframework.zip",
            checksum: "78064690dcd0a7127ac8e013ec29ca0b4ec61620b31921d181b505059c3520b8"
        ),
        .binaryTarget(
            name: "AppSpectorTVSDK",
            path: "AppSpectorTVSDK/AppSpectorTVSDK.xcframework.zip",
